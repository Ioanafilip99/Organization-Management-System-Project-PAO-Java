...
public class Organizatie implements OrganizatieInterfata {
    ...
    public Manager alegeManager(int index) {
        if(angajati.get(index) instanceof Manager) {
            return (Manager) angajati.get(index);
        }
        else {
            System.out.println("Nu exista manager la indexul " + index);
            return null;
        }
    }
    ...
    public Programator alegeProgramator(int index) {
        if(angajati.get(index) instanceof Programator) {
            return (Programator) angajati.get(index);
        }
        else {
